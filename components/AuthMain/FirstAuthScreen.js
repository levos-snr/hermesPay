                ...
                <ScrollView style = {{flex: 1, width: '100%'}} contentContainerStyle = {{alignItems: 'center'}}>
                    <View style = {styles.screen}>
                        ...
                        <View style = {styles.bottomSection}>
                            ...
                            isLogin?
                                <>
                                    <Text style = {{color: 'black', opacity: 0.5, textAlign: 'center', fontWeight: '500'}} >Or Sign in with</Text>
                            ...
                            :
                                <>
                                    <View style = {{flex: 1, flexDirection: 'row'}}>
                                        <Text style = {{color: '#000', alignSelf: 'flex-end', marginBottom: 10, textAlign: 'center'}}>By signing up, you agree to the <Text style = {{color: '#7562EB'}}>Terms & Conditions</Text> of this app.</Text>
                                    </View>
                                </>
                        }</View>
                    </View>
